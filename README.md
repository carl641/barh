...
- **Photography.** The series tiles and hero art are line drawings; the founder tiles are gradient
  placeholders. Real photos should replace the `.ph` / `.hero-art` blocks.
